...
run:
	xhost +
	docker run --rm -ti --env=DISPLAY=${DISPLAY} --ipc=host --volume=vaudtax-$(YEAR):/home/vaudtax/VaudTax$(YEAR):rw --volume=/tmp/.X11-unix:/tmp/.X11-unix --volume=${HOME}/Documents/vaudtax:/home/vaudtax $(DOCKER_BASE):${YEAR}
